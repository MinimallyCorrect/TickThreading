		...
		if (nbttagcompound.hasKey("TileTicks")) {
			...
			if (nbttaglist3 != null) {
				for (int j1 = 0; j1 < nbttaglist3.tagCount(); ++j1) {
					...
					world.scheduleBlockUpdateFromLoad(nbttagcompound5.getInteger("x"), nbttagcompound5.getInteger("y"), nbttagcompound5.getInteger("z"), nbttagcompound5.getInteger("i"), nbttagcompound5.getInteger("t"));
					// TODO: 1.5 - , nbttagcompound5.getInteger("p"));
				}
			}
		}
	}
